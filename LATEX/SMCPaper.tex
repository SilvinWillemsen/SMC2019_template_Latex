...
\subsection{Connections}
Increasing $\omega_1 \gtrsim 100,000$ while keeping $0 < \omega_0 \lesssim 100$ will cause audible non-linear behaviour, such as pitch-glides and rattling sounds. These effects will be more dominant when the plate stiffness is higher. %string resonances?
...
\fbox{\parbox{0.93\linewidth}{
 \While{application runs}{
  \For{all elements}{
   calculate intermediate state $u^\text{I}$ using previous state values (as in Equation \eqref{eq:FDSform})
