...
Parameters for the bowed strings abide the following conditions: $\abs{v_\text{B}} \leq 1$ m/s and $0 \leq F_\text{B} \leq 100$ N. It was chosen to discretise Equation \eqref{eq:relVelocity} implicitly %(STEFAN?)
